...
treklet.util.ellipsize = function(a, b) {
  return cljs.core.truth_(a.length > b) ? cljs.core.str.call(null, a.splice(0, b), "...") : a
};
treklet.server = {};
treklet.server.localstorage = {};
treklet.server.localstorage.core = {};
treklet.server.localstorage.core.start = function() {
  return goog.events.listenOnce.call(null, window, goog.events.EventType.LOAD, function() {
    var a = (new goog.Uri(window.location.href)).getParameterValue("xpc");
    if(cljs.core.truth_(a)) {
      var a = goog.json.parse.call(null, a), b = new goog.net.xpc.CrossPageChannel(a);
      b.registerService("write", function(a) {
        a = cljs.core.js__GT_clj.call(null, goog.json.parse.call(null, a), "\ufdd0'keywordize-keys", !0);
        localStorage.setItem(a.call(null, "\ufdd0'k"), goog.json.serialize.call(null, treklet.util.clj__GT_js.call(null, a.call(null, "\ufdd0'v"))));
        return b.send("on-write-complete")
      });
      b.registerService("read", function(a) {
        a = cljs.core.js__GT_clj.call(null, goog.json.parse.call(null, a), "\ufdd0'keywordize-keys", !0);
        a = localStorage.getItem(a.call(null, "\ufdd0'k"));
        return b.send("on-read-complete", a)
      });
      b.registerService("clear", function() {
        alert.call(null, "Clearing Localstorage");
        localStorage.clear();
        return b.send("on-clear-complete")
      });
