...
}, "\ufdd0'scrim":m, "\ufdd0'name":"intelimap_js.gui.kinds.MessageBox", "\ufdd0'centered":k, "\ufdd0'autoDismiss":m, "\ufdd0'style":"background-color:#f2f1f0;color:black;-webkit-box-shadow:19px 19px 25px rgba(0,0,0,.3) !important;background-image:none;padding:30px;z-index:160000;", "\ufdd0'keydown":function(a, b) {
...
"\ufdd0'name":"balloonTextColorButton", "\ufdd0'ontap":"colorButtonTapped", "\ufdd0'style":"-webkit-box-sizing:border-box;box-sizing:border-box;-moz-box-sizing:border-box;display:block;width:85%;margin:10px auto 10px auto !important;padding-left:10px;padding-right:10px;", "\ufdd0'content":"Username Background Color"})]), "\ufdd0'uploadAvatarImage":function() {
  ...
  if(z(a)) {
    ...
    i.setAttribute("onerror", [Q("this.src="), Q("'"), Q(An), Q("anon.png"), Q("'")].join(""));
...
function Kp(a) {
  return Pf([k, m], [Pi, Si]).call(l, a).call(l, document.body, "click", Fp)
}
function Lp(a) {
  ...
  Uo(function(a) {
    return Kp(Rc(a.a ? a.a("\ufdd0'visible") : a.call(l, "\ufdd0'visible")))
  });
  Kp(k);
...
function Mp() {
  setTimeout(function() {
    return Ep.sendNotification(Cn(T(["\ufdd0'title", "\ufdd0'message"], {"\ufdd0'title":"Treklet:", "\ufdd0'message":"Try double clicking your avatar."})))
  }, 15E3);
  return wp("Please Enter a Username:", "There's no signup, use anything you like.", "", S(["Alright Let's Go!"]), function(a) {
    ...
    return Lp(T(["\ufdd0'username", "\ufdd0'balloon-bg-color", "\ufdd0'balloon-text-color", "\ufdd0'name-bg-color", "\ufdd0'name-text-color"], {"\ufdd0'username":a, "\ufdd0'balloon-bg-color":"#CEF6F6", "\ufdd0'balloon-text-color":"#008800", "\ufdd0'name-bg-color":"#FFFF81", "\ufdd0'name-text-color":"#FA5882"}))
  })
}
function Np() {
  if(Ac.m(window.TREKLET_RUNNING, g)) {
    ...
    a.renderInto(b);
    setTimeout(function() {
      return a.sendNotification(Cn(T(["\ufdd0'title", "\ufdd0'message"], {"\ufdd0'title":"Treklet:", "\ufdd0'message":"Please Support our <a href='http://www.kickstarter.com' style='color:white;'> Kickstarter! </a>"})))
    }, 5E3);
    ji(document.body, b);
    return Ln(function() {
